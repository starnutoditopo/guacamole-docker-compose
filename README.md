...
This project was forked from https://github.com/boschkundendienst/guacamole-docker-compose .

Minor Powershell scripts have been added do run Guacamole on Windows through Docker.
...
Note: technically, the `prepare.ps1` script runs the `./prepare.sh` script in  _Docker-in-Docker_ container.
